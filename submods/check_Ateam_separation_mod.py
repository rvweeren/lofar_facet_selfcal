...
# Modified for facetselfcal by Reinout van Weeren (rvweeren@strw.leidenuniv.nl), March 2026
...
targets = [ {'name' : 'CasA', 'ra' : 6.123487680622104,  'dec' : 1.0265153995604648},
            ...
            {'name' : 'SagA*', 'ra' : 4.649644209, 'dec' : -0.505031613},
            {'name' : 'ForA',  'ra' : 0.881043755, 'dec' : -0.649636939},
            {'name' : 'CenA',  'ra' : 3.514560490, 'dec' : -0.750865238},
            {'name' : 'Sun'},
            {'name' : 'Jupiter'},
            {'name' : 'Moon'}]
